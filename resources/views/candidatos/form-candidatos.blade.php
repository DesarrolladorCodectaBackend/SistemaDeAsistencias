                    ...
                    <div class="ibox ">
                        <div class="ibox-content">
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <form role="form">
                                        <div class="form-group"><label>Nombres</label> <input type="text" placeholder="Ingrese su nombre" value="{{$candidato->nombre}} {{$candidato->apellido}}" class="form-control" disabled></div>
                                        <div class="form-group"><label>DNI</label> <input type="text" placeholder="Ingrese su DNI" value="{{$candidato->dni}}" class="form-control" disabled></div>
                                        <div class="form-group"><label class="col-form-label">Carrera</label><input type="text" value="{{$candidato->carrera->nombre}}" class="form-control" disabled>
                                        </div>
                                    </form>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group"><label>Correo</label> <input type="email" placeholder="Ingrese su correo" value="{{$candidato->correo}}" class="form-control" disabled></div>
                                    <div class="form-group"><label>Telefono</label> <input type="text" placeholder="Ingrese su telefono" value="{{$candidato->celular}}" class="form-control" disabled></div>
