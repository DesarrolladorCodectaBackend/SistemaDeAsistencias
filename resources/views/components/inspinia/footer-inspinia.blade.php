...
<footer class="footer text-light py-3 px-4 mt-4" style="background-color: #2f4050;">
  <div class="d-flex justify-content-between align-items-center flex-wrap gap-3">
    <div>
      <strong>Codecta</strong> ©️ 2024 - 2025
    </div>
    <div class="small">
      +51 922 546 863
    </div>
    <div class="small">
      <a href="mailto:codectaperu@gmail.com" class="text-light text-decoration-none">
