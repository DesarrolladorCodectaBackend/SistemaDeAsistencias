...
<head>
    ...
    <title>INSPINIA| Proyectos</title>
</head>
    ...
    <div id="wrapper">
        ...
        <div class="row wrapper border-bottom white-bg page-heading">
            ...
            <div class="col-lg-6 d-flex align-items-center gap-10">
                <h2>Cant. Áreas: <span class="font-bold text-danger">proyecto</span></h2>
                <h2>Cant. Colaboradores: <span class="font-bold text-danger">proyecto</span></h2>
            </div>
