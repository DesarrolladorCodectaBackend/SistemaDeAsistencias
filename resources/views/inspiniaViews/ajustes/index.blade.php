                    ...
                    <div class="ibox ">    
                        <div class="show-grid container-fluid">
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <a class="btn btn-success" href="config-carrera.html"><i class="fa fa-cog"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="ibox ">    
                        <div class="show-grid container-fluid">
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <a class="btn btn-success" href="config-curso.html"><i class="fa fa-cog"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="ibox ">    
                        <div class="show-grid container-fluid">
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <a class="btn btn-success" href="config-programas.html"><i class="fa fa-cog"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="ibox ">    
                        <div class="show-grid container-fluid">
                            <div class="row">
                                ...
                                <div class="col-sm-2">
                                    <a class="btn btn-success" href="config-herramientas.html"><i class="fa fa-cog"></i></a>
                                </div>
                            </div>
                        </div>
                    </div>
