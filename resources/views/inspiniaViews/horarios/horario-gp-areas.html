    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
        <div class="sidebar-collapse">
            <ul class="nav metismenu" id="side-menu">
                ...
                <li>
                    <a href="horario-general-presencial.html"><i class="fa fa-clock-o"></i> <span class="nav-label">Horarios Generales</span><span class="fa arrow"></span></a>
                    <ul class="nav nav-second-level">
                        <li><a href="horario_general_presencial.blade.php">Presencial</a></li>
                        <li><a href="reuniones_generales.blade.php">Reuniones Áres</a></li>
<<<<<<< <li><a href="horario-gp-areas.html">Areas</a></li>
=======
                        <li class="active"><a href="horario-gp-areas.html">Areas</a></li>
>>>>>>> 2cc4d18ab1c800a87ebfe55239a44f68f9e868d3
                ...
                <li>
                    <a href="configuracion.html"><i class="fa fa-cog"></i> <span class="nav-label">Ajustes</span></a>
                </li>
                <li>
        ...
        <div class="col-lg-12">
          <div class="ibox ">
            <div class="ibox-content">
                <h1 class="titulo">Horario General Presencial - Areas</h1>
                <br>
                <div class="container">
                  <table>
