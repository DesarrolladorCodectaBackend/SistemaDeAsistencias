                        ...
                        <tbody>
                           {{-- ARRAY OBJETOS --}}
                            ...
                            <tr>
                                ...
                                <td>{{ $libro->titulo }}</td>
                                <td>{{ $libro->autor }}</td>
                                <td><form method="POST" action="{{ route('libro.activarInactivar', $libro->id) }}">

                                    @csrf
                                    <button type="submit" class="btn btn-{{ $libro->estado ? 'outline-success' : 'danger' }} btn-primary dim">
                                        <span>{{ $libro->estado ? 'Activado' : 'Inactivo' }}</span>
                                    </button>
                                </form></td>
